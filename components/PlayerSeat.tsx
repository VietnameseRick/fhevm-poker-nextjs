    ...
    <div className={`flex flex-col gap-2 ${positionClasses[position]} relative items-center`}>
      ...
      <div className="relative flex flex-col items-center">
        ...
        {cards && cards.length > 0 && (
          <div className="absolute -top-6 right-[-100px] flex">
            <CardHand cards={cards} hidden={!showCards || hasFolded} />
          </div>
        )}

        {/* 💰 Info box — đè lên avatar */}
        <div className="absolute bottom-[-40px] z-10 bg-green-500/30 text-white px-4 py-2 rounded-2xl text-center backdrop-blur-sm border border-green-700 shadow-md">
